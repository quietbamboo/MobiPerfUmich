...
public class Basic extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        for(int i = 0; i< com.mobiperf.ui.Display.titles_basic.size(); i++){
        	list_title.get(i).setText(com.mobiperf.ui.Display.titles_basic.get(i));
        	list_description.get(i).setText(com.mobiperf.ui.Display.description_basic.get(i));
        	list_result.get(i).setText(com.mobiperf.ui.Display.result_basic.get(i));
        }
