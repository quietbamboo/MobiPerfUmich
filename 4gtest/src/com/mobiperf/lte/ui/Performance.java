...
public class Performance extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        for(int i = 0; i < com.mobiperf.lte.ui.Display.titles_performance.size(); i++){
        	list_title.get(i).setText(com.mobiperf.lte.ui.Display.titles_performance.get(i));
        	list_description.get(i).setText(com.mobiperf.lte.ui.Display.description_performance.get(i));
        	list_result.get(i).setText(com.mobiperf.lte.ui.Display.result_performance.get(i));
        }
