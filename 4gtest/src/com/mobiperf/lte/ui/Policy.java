...
public class Policy extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        for(int i = 0; i< com.mobiperf.lte.ui.Display.titles_policy.size(); i++){
        	list_title_policy.get(i).setText(com.mobiperf.lte.ui.Display.titles_policy.get(i));
        	list_descripton_policy.get(i).setText(com.mobiperf.lte.ui.Display.description_policy.get(i));
        	list_result_policy.get(i).setText(com.mobiperf.lte.ui.Display.result_policy.get(i));
        }
